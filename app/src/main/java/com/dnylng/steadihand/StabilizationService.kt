            ...
            when (event.sensor.type) {
                Sensor.TYPE_GAME_ROTATION_VECTOR -> {
                    if (isInitReading) {
                        ...
                        view.rotation = (referenceAngles[0] - result.z) * sensitivity
                        view.rotationX = (referenceAngles[1] - result.x) * sensitivity
                        view.rotationY = (referenceAngles[2] - result.y) * sensitivity
                    }
                }
                Sensor.TYPE_LINEAR_ACCELERATION -> {
                    ...
                    if (timestamp == 0L) {
                        ...
                        view.getLocationOnScreen(referencePosition)
                    } else {
                    ...
                    view.translationX = -position[0]
                    view.translationY = position[1]
                }
            }
        }
    }
